...
function Achievement() {
  const [achievement, setAchievement] = useState([
    ...
    {
      year: 2018,
      achievement: ["Juara 1 Robot Pemadam Api Indonesia Tingkat Regional 1"],
    },
    {
      year: 2019,
      achievement: [
    ...
    <div id="achievement" className="achievement">
      ...
      >
        <Card className="d-flex text-center align-items-center mt-4">
          ...
          <img
            className="m-2"
            src={process.env.PUBLIC_URL + "/image/KRILogo.png"}
          />
      ...
      >
        <Card className="d-flex text-center align-items-center mt-4">
          ...
          <img
            className="m-2"
            src={process.env.PUBLIC_URL + "/image/KRTILogo.png"}
          />
          <div className="d-flex text-center flex-wrap justify-content-evenly align-items-center">
            <Form>
